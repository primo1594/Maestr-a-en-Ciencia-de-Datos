...
###########################################################
###########################################################
#     Ejercicio estad???sticas descriptivas 
#                        y 
...
# otra forma, pero da menos informaci???n
# 
summary(data)

# Veamos los gr???ficos de los datos.
...
# una opci???n es emplear una prueba que no tiene
# supuestos. Se conoce como la prueba no param???trica
# de Tukey (tambien conocida como el m???todo de Tukey (o Tukey's honest
#  significance test, Tukey's HSD (honest significant difference) test
#  ,or the Tukey Kramer method)
TukeyHSD(fit)

#Tambi???n podemos graficar los resultados
