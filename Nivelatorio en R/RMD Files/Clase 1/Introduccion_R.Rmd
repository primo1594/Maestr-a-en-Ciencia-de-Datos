...
```{R ejercicioFactor1}
# 1 linea de código
PatientStatus <- factor(c("Poor","Improved","Excellent"), levels = c("Poor","Improved","Excellent"))
# -------------------
PatientStatus
```
...
xFactor <- factor(x, levels=c(11,22,47), ordered=TRUE)
xFactor
# -------------------
```
_Ejercicio 13_
...
```{R listExample2}
mylist[[2]]
mylist[[3]][1,] #retorna la matriz e imprime la primera fila
mylist[["ages"]]
```
